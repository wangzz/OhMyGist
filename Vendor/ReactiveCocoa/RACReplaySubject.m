...
+ (instancetype)replaySubjectWithCapacity:(NSUInteger)capacity {
	return [[self alloc] initWithCapacity2:capacity];
}

- (instancetype)init {
	return [self initWithCapacity2:RACReplaySubjectUnlimitedCapacity];
}

- (instancetype)initWithCapacity2:(NSUInteger)capacity {
	self = [super init];
